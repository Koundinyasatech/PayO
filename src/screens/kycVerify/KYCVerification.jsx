...
//   TextInput,
//   ActivityIndicator,
//   PermissionsAndroid, // Added PermissionsAndroid here
// } from 'react-native';
...
export default function KYCVerification({
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // Included safety check in case otherIdFile wasnt populated but api call was kept as requested
      if (otherIdFile) {
         console.log('Starting Other ID upload...');
         await uploadPassport();
      }
      ...
      <ScrollView
        ...
        <View style={styles.container}>
          ...
          <View style={{ paddingVertical: 10 }}>
            {/* Top Row: Aadhaar and PAN (Wide Buttons) */}
            <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginBottom: 10 }}>
              <TouchableOpacity
                style={[
                  styles.tabButton,
                  activeTab === 'aadhaar' && styles.activeTab,
                  { flex: 0.48, paddingHorizontal: 5, justifyContent: 'center', alignItems: 'center' } 
                ]}
                onPress={() => setActiveTab('aadhaar')}>
                <Text
                  style={[
            ...
            {/* Bottom Row: Bank Documents (Forced to exactly 3 columns on one line) */}
            <View style={{ flexDirection: 'row', justifyContent: 'space-between', gap: 6 }}>
              <TouchableOpacity
                style={[
                  styles.tabButton,
                  activeTab === 'passbook' && styles.activeTab,
                  { flex: 1, justifyContent: 'center', alignItems: 'center', paddingHorizontal: 2 }
                ]}
