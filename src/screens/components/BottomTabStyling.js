...
//     alignSelf: 'center',
//   },
//   // Inactive container size & alignment matching Active container exactly
...
export const styles = StyleSheet.create({
  ...
  circleBackgroundPatch: {
    ...
    zIndex: -100, // Sits exactly behind the green button to cover up the screen gap
  },
  btnCircle: {
    width: moderateScale(58),
    height: moderateScale(58),
