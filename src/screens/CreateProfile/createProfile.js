...
export default function ProfileScreen({ navigation }) {
  ...
  // Overall form validity: Name is required, Email is optional (but must be valid if entered)
      ...
      >
        <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
          ...
          >
            ...
            <View style={[styles.inputWrapper, errors.name && styles.errorInput, isValidName && styles.validInput]}>
              <TextInput
                style={styles.inputField}
                value={name}
                onChangeText={(text) => handleChange('name', text)}
            ...
            <View style={[styles.inputWrapper, errors.email && styles.errorInput, (email.length > 0 && isValidEmail) && styles.validInput]}>
              <TextInput
                style={styles.inputField}
                value={email}
                onChangeText={(text) => handleChange('email', text)}
            ...
            <View style={[styles.inputWrapper, referral.trim().length > 0 && styles.validInput]}>
              <TextInput
                style={styles.inputField}
                value={referral}
                onChangeText={(text) => handleChange('referral', text)}
