...
const styles = StyleSheet.create({
  ...
  header: {
    ...
    alignItems: 'center',
    justifyContent: 'space-between',
    marginTop: hp('2%'),        // Changed from hp('4%') to hp('2%') to match Profile alignment perfectly
    marginBottom: hp('1.5%'),
    paddingHorizontal: wp('5%'), // Added padding to align properly outside the scroll container
  },
  backButtonCircle: {
    width: moderateScale(36),
    height: moderateScale(36),
